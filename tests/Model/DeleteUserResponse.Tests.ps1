...
Describe -tag 'WatchtowrAPI' -name 'DeleteUserResponse' {
    Context 'DeleteUserResponse' {
        It 'Initialize-DeleteUserResponse' {
            # a simple test to create an object
            #$NewObject = Initialize-DeleteUserResponse -Success "TEST_VALUE"
            #$NewObject | Should -BeOfType DeleteUserResponse
