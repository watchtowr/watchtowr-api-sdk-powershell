...
Describe -tag 'PSOpenAPITools' -name 'ClientIpData' {
    Context 'ClientIpData' {
        It 'Initialize-ClientIpData' {
            # a simple test to create an object
            #$NewObject = Initialize-ClientIpData -VarData "TEST_VALUE"
            #$NewObject | Should -BeOfType ClientIpData
