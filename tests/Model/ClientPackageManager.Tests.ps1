...
Describe -tag 'WatchtowrAPI' -name 'ClientPackageManager' {
    Context 'ClientPackageManager' {
        It 'Initialize-ClientPackageManager' {
            ...
            #$NewObject = Initialize-ClientPackageManager -DiscoveryReason "TEST_VALUE" -Type "TEST_VALUE" -Name "TEST_VALUE" -Source "TEST_VALUE" -Status "TEST_VALUE" -CreatedAt "TEST_VALUE" -Id "TEST_VALUE" -Url "TEST_VALUE" -Platform "TEST_VALUE" -BusinessUnits "TEST_VALUE" -Metadata "TEST_VALUE" -CustomProperties "TEST_VALUE" -Criticality "TEST_VALUE"
