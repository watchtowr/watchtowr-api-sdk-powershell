...
Describe -tag 'WatchtowrAPI' -name 'TargetIndustry' {
    Context 'TargetIndustry' {
        It 'Initialize-TargetIndustry' {
            # a simple test to create an object
            #$NewObject = Initialize-TargetIndustry -Name "TEST_VALUE" -Count "TEST_VALUE"
            #$NewObject | Should -BeOfType TargetIndustry
