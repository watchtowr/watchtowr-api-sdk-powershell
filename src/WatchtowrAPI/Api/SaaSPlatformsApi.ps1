...
.PARAMETER Id
The asset ID of the SaaS Platform to retrieve changelog for.
...
#>
function Get-AssetSaasPlatformChangelog {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [Decimal]
    ...
    Process {
        'Calling method: Get-AssetSaasPlatformChangelog' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/client/assets/saasPlatform/show/{id}/changelog'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getAssetSaasPlatformChangelog."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "GetAssetSaasPlatformChangelog200Response" `
                                -IsBodyNullable $false
...
.PARAMETER Id
The asset ID of the SaaS Platform to set criticality for.
...
#>
function Set-CriticalitySaasPlatform {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [Decimal]
    ...
    Process {
        'Calling method: Set-CriticalitySaasPlatform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/client/assets/saasPlatform/show/{id}/criticality'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling setCriticalitySaasPlatform."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))

        if (!$SetCriticalityDto) {
            throw "Error! The required parameter `SetCriticalityDto` missing when calling setCriticalitySaasPlatform."
        }
