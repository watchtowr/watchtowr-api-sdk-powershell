...
.PARAMETER Id
The asset ID of the API documentation to retrieve changelog for.
...
function Get-AssetApiDocumentationChangelog {
    ...
    Process {
        'Calling method: Get-AssetApiDocumentationChangelog' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/client/assets/apiDocumentation/show/{id}/changelog'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getAssetApiDocumentationChangelog."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
.PARAMETER Id
The asset ID of the API Documentation to set criticality for.
...
#>
function Set-CriticalityApiDocumentation {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [Decimal]
    ...
    Process {
        'Calling method: Set-CriticalityApiDocumentation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/client/assets/apiDocumentation/show/{id}/criticality'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling setCriticalityApiDocumentation."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))

        if (!$SetCriticalityDto) {
            throw "Error! The required parameter `SetCriticalityDto` missing when calling setCriticalityApiDocumentation."
        }
