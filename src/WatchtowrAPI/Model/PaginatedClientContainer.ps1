...
function Initialize-PaginatedClientContainer {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedClientContainer' | Write-Debug
...
function ConvertFrom-JsonToPaginatedClientContainer {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedClientContainer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
