...
function Initialize-PaginatedApiDocumentation {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedApiDocumentation' | Write-Debug
...
function ConvertFrom-JsonToPaginatedApiDocumentation {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedApiDocumentation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
