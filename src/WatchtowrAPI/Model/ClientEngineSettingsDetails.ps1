...
ClientEngineSettingsDetails<PSCustomObject>
#>

function Initialize-ClientEngineSettingsDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientEngineSettingsDetails' | Write-Debug
...
Convert from JSON to ClientEngineSettingsDetails<PSCustomObject>
...
ClientEngineSettingsDetails<PSCustomObject>
#>
function ConvertFrom-JsonToClientEngineSettingsDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientEngineSettingsDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
