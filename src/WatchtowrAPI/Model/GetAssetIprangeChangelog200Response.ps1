...
GetAssetIprangeChangelog200Response<PSCustomObject>
#>

function Initialize-GetAssetIprangeChangelog200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => GetAssetIprangeChangelog200Response' | Write-Debug
...
Convert from JSON to GetAssetIprangeChangelog200Response<PSCustomObject>
...
GetAssetIprangeChangelog200Response<PSCustomObject>
#>
function ConvertFrom-JsonToGetAssetIprangeChangelog200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => GetAssetIprangeChangelog200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetAssetIprangeChangelog200Response
