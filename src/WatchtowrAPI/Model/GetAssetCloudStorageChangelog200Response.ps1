...
GetAssetCloudStorageChangelog200Response<PSCustomObject>
#>

function Initialize-GetAssetCloudStorageChangelog200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => GetAssetCloudStorageChangelog200Response' | Write-Debug
...
Convert from JSON to GetAssetCloudStorageChangelog200Response<PSCustomObject>
...
GetAssetCloudStorageChangelog200Response<PSCustomObject>
#>
function ConvertFrom-JsonToGetAssetCloudStorageChangelog200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => GetAssetCloudStorageChangelog200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetAssetCloudStorageChangelog200Response
