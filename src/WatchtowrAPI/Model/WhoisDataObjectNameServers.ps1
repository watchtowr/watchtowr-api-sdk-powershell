...
WhoisDataObjectNameServers<PSCustomObject>
#>
function ConvertFrom-JsonToWhoisDataObjectNameServers {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'String' defined in oneOf (WhoisDataObjectNameServers). Proceeding to the next one if any."
        }
