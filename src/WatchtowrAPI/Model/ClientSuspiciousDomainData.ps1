...
function Initialize-ClientSuspiciousDomainData {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientSuspiciousDomainData' | Write-Debug
...
function ConvertFrom-JsonToClientSuspiciousDomainData {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientSuspiciousDomainData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
