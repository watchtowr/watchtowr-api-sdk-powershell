...
function Initialize-ClientIpDnsRecordPointingAtData {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientIpDnsRecordPointingAtData' | Write-Debug
...
function ConvertFrom-JsonToClientIpDnsRecordPointingAtData {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientIpDnsRecordPointingAtData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
