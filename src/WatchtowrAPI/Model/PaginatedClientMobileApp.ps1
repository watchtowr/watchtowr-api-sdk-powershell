...
function Initialize-PaginatedClientMobileApp {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedClientMobileApp' | Write-Debug
...
function ConvertFrom-JsonToPaginatedClientMobileApp {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedClientMobileApp' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
