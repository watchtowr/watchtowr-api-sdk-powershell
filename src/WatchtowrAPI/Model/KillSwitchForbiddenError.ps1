...
function Initialize-KillSwitchForbiddenError {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => KillSwitchForbiddenError' | Write-Debug
...
function ConvertFrom-JsonToKillSwitchForbiddenError {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => KillSwitchForbiddenError' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
