...
function Initialize-PaginatedClientCustomProperty {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedClientCustomProperty' | Write-Debug
...
function ConvertFrom-JsonToPaginatedClientCustomProperty {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedClientCustomProperty' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
