...
ClientActiveDefenseRuleData<PSCustomObject>
#>

function Initialize-ClientActiveDefenseRuleData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientActiveDefenseRuleData' | Write-Debug
...
Convert from JSON to ClientActiveDefenseRuleData<PSCustomObject>
...
ClientActiveDefenseRuleData<PSCustomObject>
#>
function ConvertFrom-JsonToClientActiveDefenseRuleData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientActiveDefenseRuleData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientActiveDefenseRuleData
        $AllProperties = ("data")
