...
GetAssetMobileAppChangelog200Response<PSCustomObject>
#>

function Initialize-GetAssetMobileAppChangelog200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => GetAssetMobileAppChangelog200Response' | Write-Debug
...
Convert from JSON to GetAssetMobileAppChangelog200Response<PSCustomObject>
...
GetAssetMobileAppChangelog200Response<PSCustomObject>
#>
function ConvertFrom-JsonToGetAssetMobileAppChangelog200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => GetAssetMobileAppChangelog200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetAssetMobileAppChangelog200Response
