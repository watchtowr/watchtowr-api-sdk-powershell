...
.PARAMETER VarData
Returns a single-element array containing all finding statuses.
.OUTPUTS

FindingStatusesResponse<PSCustomObject>
#>

function Initialize-FindingStatusesResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => FindingStatusesResponse' | Write-Debug
...
Convert from JSON to FindingStatusesResponse<PSCustomObject>
...
FindingStatusesResponse<PSCustomObject>
#>
function ConvertFrom-JsonToFindingStatusesResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => FindingStatusesResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FindingStatusesResponse
        $AllProperties = ("data")
