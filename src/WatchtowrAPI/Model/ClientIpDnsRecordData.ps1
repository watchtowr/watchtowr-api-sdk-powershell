...
function Initialize-ClientIpDnsRecordData {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientIpDnsRecordData' | Write-Debug
...
function ConvertFrom-JsonToClientIpDnsRecordData {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientIpDnsRecordData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
