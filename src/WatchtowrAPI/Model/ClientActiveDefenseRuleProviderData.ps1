...
function Initialize-ClientActiveDefenseRuleProviderData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientActiveDefenseRuleProviderData' | Write-Debug
...
Convert from JSON to ClientActiveDefenseRuleProviderData<PSCustomObject>
...
ClientActiveDefenseRuleProviderData<PSCustomObject>
#>
function ConvertFrom-JsonToClientActiveDefenseRuleProviderData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientActiveDefenseRuleProviderData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
