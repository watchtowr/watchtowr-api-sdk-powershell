...
.PARAMETER VarData
Whitelisted IP details
.OUTPUTS

WhitelistIpDataSingle<PSCustomObject>
#>

function Initialize-WhitelistIpDataSingle {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => WhitelistIpDataSingle' | Write-Debug
...
Convert from JSON to WhitelistIpDataSingle<PSCustomObject>
...
WhitelistIpDataSingle<PSCustomObject>
#>
function ConvertFrom-JsonToWhitelistIpDataSingle {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => WhitelistIpDataSingle' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WhitelistIpDataSingle
        $AllProperties = ("data")
