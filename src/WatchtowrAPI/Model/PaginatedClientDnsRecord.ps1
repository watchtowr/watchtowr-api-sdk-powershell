...
.PARAMETER VarData
List of DNS record items
.PARAMETER Meta
No description available.
.OUTPUTS

PaginatedClientDnsRecord<PSCustomObject>
#>

function Initialize-PaginatedClientDnsRecord {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedClientDnsRecord' | Write-Debug
...
Convert from JSON to PaginatedClientDnsRecord<PSCustomObject>
...
PaginatedClientDnsRecord<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientDnsRecord {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedClientDnsRecord' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientDnsRecord
