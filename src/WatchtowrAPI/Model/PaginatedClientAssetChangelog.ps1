...
PaginatedClientAssetChangelog<PSCustomObject>
#>

function Initialize-PaginatedClientAssetChangelog {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedClientAssetChangelog' | Write-Debug
...
Convert from JSON to PaginatedClientAssetChangelog<PSCustomObject>
...
PaginatedClientAssetChangelog<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientAssetChangelog {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedClientAssetChangelog' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientAssetChangelog
