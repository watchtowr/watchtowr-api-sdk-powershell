...
PaginatedClientCompromisedEndpointHarvestedCredentials<PSCustomObject>
#>

function Initialize-PaginatedClientCompromisedEndpointHarvestedCredentials {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedClientCompromisedEndpointHarvestedCredentials' | Write-Debug
...
Convert from JSON to PaginatedClientCompromisedEndpointHarvestedCredentials<PSCustomObject>
...
PaginatedClientCompromisedEndpointHarvestedCredentials<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientCompromisedEndpointHarvestedCredentials {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedClientCompromisedEndpointHarvestedCredentials' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientCompromisedEndpointHarvestedCredentials
