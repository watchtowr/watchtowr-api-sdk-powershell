...
function Initialize-PaginatedServiceInformationResponse {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedServiceInformationResponse' | Write-Debug
...
function ConvertFrom-JsonToPaginatedServiceInformationResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedServiceInformationResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
