...
function Initialize-ClientBusinessUnitRuleData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientBusinessUnitRuleData' | Write-Debug
...
Convert from JSON to ClientBusinessUnitRuleData<PSCustomObject>
...
ClientBusinessUnitRuleData<PSCustomObject>
#>
function ConvertFrom-JsonToClientBusinessUnitRuleData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientBusinessUnitRuleData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
