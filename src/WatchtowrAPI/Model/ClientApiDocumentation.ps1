...
function Initialize-ClientApiDocumentation {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientApiDocumentation' | Write-Debug
...
function ConvertFrom-JsonToClientApiDocumentation {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientApiDocumentation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
