...
function Initialize-ClientBusinessUnitData {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientBusinessUnitData' | Write-Debug
...
function ConvertFrom-JsonToClientBusinessUnitData {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientBusinessUnitData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
