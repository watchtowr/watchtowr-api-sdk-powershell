...
function Initialize-ClientCloudStorageData {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientCloudStorageData' | Write-Debug
...
function ConvertFrom-JsonToClientCloudStorageData {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientCloudStorageData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
