...
function Initialize-PaginatedClientCloudStorage {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedClientCloudStorage' | Write-Debug
...
function ConvertFrom-JsonToPaginatedClientCloudStorage {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedClientCloudStorage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
