...
function Initialize-CreateClientCustomPropertyDto {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => CreateClientCustomPropertyDto' | Write-Debug
...
function ConvertFrom-JsonToCreateClientCustomPropertyDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => CreateClientCustomPropertyDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
