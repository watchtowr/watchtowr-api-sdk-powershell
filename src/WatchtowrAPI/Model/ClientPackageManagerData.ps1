...
function Initialize-ClientPackageManagerData {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientPackageManagerData' | Write-Debug
...
function ConvertFrom-JsonToClientPackageManagerData {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientPackageManagerData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
