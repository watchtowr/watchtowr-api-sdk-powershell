...
function Initialize-ClientIpDnsRecordResponse {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientIpDnsRecordResponse' | Write-Debug
...
function ConvertFrom-JsonToClientIpDnsRecordResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientIpDnsRecordResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
