...
GetAssetPackageManagerChangelog200Response<PSCustomObject>
#>

function Initialize-GetAssetPackageManagerChangelog200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => GetAssetPackageManagerChangelog200Response' | Write-Debug
...
Convert from JSON to GetAssetPackageManagerChangelog200Response<PSCustomObject>
...
GetAssetPackageManagerChangelog200Response<PSCustomObject>
#>
function ConvertFrom-JsonToGetAssetPackageManagerChangelog200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => GetAssetPackageManagerChangelog200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetAssetPackageManagerChangelog200Response
