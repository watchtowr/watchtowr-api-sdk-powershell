...
function Initialize-HostnameBusinessUnitIDsDTO {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => HostnameBusinessUnitIDsDTO' | Write-Debug
...
function ConvertFrom-JsonToHostnameBusinessUnitIDsDTO {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => HostnameBusinessUnitIDsDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
