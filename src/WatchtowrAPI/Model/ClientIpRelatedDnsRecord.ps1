...
function Initialize-ClientIpRelatedDnsRecord {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientIpRelatedDnsRecord' | Write-Debug
...
function ConvertFrom-JsonToClientIpRelatedDnsRecord {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientIpRelatedDnsRecord' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
