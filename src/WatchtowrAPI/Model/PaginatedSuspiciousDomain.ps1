...
function Initialize-PaginatedSuspiciousDomain {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedSuspiciousDomain' | Write-Debug
...
function ConvertFrom-JsonToPaginatedSuspiciousDomain {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedSuspiciousDomain' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
