...
ClientSaasPlatform<PSCustomObject>
#>

function Initialize-ClientSaasPlatform {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientSaasPlatform' | Write-Debug
...
Convert from JSON to ClientSaasPlatform<PSCustomObject>
...
ClientSaasPlatform<PSCustomObject>
#>
function ConvertFrom-JsonToClientSaasPlatform {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientSaasPlatform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientSaasPlatform
        $AllProperties = ("discovery_reason", "type", "source", "status", "created_at", "id", "url", "provider", "businessUnits", "metadata", "customProperties", "criticality")
