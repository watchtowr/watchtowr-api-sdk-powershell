...
ClientRepository<PSCustomObject>
#>
...
function Initialize-ClientRepository {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientRepository' | Write-Debug
...
Convert from JSON to ClientRepository<PSCustomObject>
...
ClientRepository<PSCustomObject>
#>
function ConvertFrom-JsonToClientRepository {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientRepository' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientRepository
        $AllProperties = ("discovery_reason", "type", "source", "status", "created_at", "id", "name", "owner", "provider", "businessUnits", "metadata", "customProperties", "criticality")
