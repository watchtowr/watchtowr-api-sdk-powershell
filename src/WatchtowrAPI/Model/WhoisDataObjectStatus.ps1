...
WhoisDataObjectStatus<PSCustomObject>
#>
function ConvertFrom-JsonToWhoisDataObjectStatus {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'String' defined in oneOf (WhoisDataObjectStatus). Proceeding to the next one if any."
        }
