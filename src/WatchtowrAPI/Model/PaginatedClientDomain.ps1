...
function Initialize-PaginatedClientDomain {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedClientDomain' | Write-Debug
...
function ConvertFrom-JsonToPaginatedClientDomain {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedClientDomain' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
