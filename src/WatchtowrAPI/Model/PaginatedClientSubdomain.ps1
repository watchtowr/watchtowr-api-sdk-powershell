...
function Initialize-PaginatedClientSubdomain {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedClientSubdomain' | Write-Debug
...
function ConvertFrom-JsonToPaginatedClientSubdomain {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedClientSubdomain' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
