...
function Initialize-PaginatedClientIpRange {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedClientIpRange' | Write-Debug
...
function ConvertFrom-JsonToPaginatedClientIpRange {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedClientIpRange' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
