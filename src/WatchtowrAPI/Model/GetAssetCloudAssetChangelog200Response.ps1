...
GetAssetCloudAssetChangelog200Response<PSCustomObject>
#>

function Initialize-GetAssetCloudAssetChangelog200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => GetAssetCloudAssetChangelog200Response' | Write-Debug
...
Convert from JSON to GetAssetCloudAssetChangelog200Response<PSCustomObject>
...
GetAssetCloudAssetChangelog200Response<PSCustomObject>
#>
function ConvertFrom-JsonToGetAssetCloudAssetChangelog200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => GetAssetCloudAssetChangelog200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetAssetCloudAssetChangelog200Response
