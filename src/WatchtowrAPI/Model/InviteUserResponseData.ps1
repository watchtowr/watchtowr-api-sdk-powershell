...
InviteUserResponseData<PSCustomObject>
#>

function Initialize-InviteUserResponseData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => InviteUserResponseData' | Write-Debug
...
Convert from JSON to InviteUserResponseData<PSCustomObject>
...
InviteUserResponseData<PSCustomObject>
#>
function ConvertFrom-JsonToInviteUserResponseData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => InviteUserResponseData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InviteUserResponseData
        $AllProperties = ("data")
