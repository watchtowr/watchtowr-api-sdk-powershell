...
GetAssetRepositoryChangelog200Response<PSCustomObject>
#>

function Initialize-GetAssetRepositoryChangelog200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => GetAssetRepositoryChangelog200Response' | Write-Debug
...
Convert from JSON to GetAssetRepositoryChangelog200Response<PSCustomObject>
...
GetAssetRepositoryChangelog200Response<PSCustomObject>
#>
function ConvertFrom-JsonToGetAssetRepositoryChangelog200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => GetAssetRepositoryChangelog200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetAssetRepositoryChangelog200Response
