...
NotFoundResponse<PSCustomObject>
#>

function Initialize-NotFoundResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => NotFoundResponse' | Write-Debug
...
Convert from JSON to NotFoundResponse<PSCustomObject>
...
NotFoundResponse<PSCustomObject>
#>
function ConvertFrom-JsonToNotFoundResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => NotFoundResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NotFoundResponse
