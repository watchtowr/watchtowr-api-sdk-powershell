...
function Initialize-ClientSourceIpsAddresses {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientSourceIpsAddresses' | Write-Debug
...
function ConvertFrom-JsonToClientSourceIpsAddresses {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientSourceIpsAddresses' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
