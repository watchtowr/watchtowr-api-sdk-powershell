...
PaginatedAdversaryIntel<PSCustomObject>
#>

function Initialize-PaginatedAdversaryIntel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedAdversaryIntel' | Write-Debug
...
Convert from JSON to PaginatedAdversaryIntel<PSCustomObject>
...
PaginatedAdversaryIntel<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedAdversaryIntel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedAdversaryIntel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedAdversaryIntel
