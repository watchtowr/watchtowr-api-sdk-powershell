...
function Initialize-ClientDnsRecordListData {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientDnsRecordListData' | Write-Debug
...
function ConvertFrom-JsonToClientDnsRecordListData {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientDnsRecordListData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
