...
function Initialize-UpdateKillSwitchResponse {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => UpdateKillSwitchResponse' | Write-Debug
...
function ConvertFrom-JsonToUpdateKillSwitchResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => UpdateKillSwitchResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
