...
.PARAMETER VarData
List of submitted seed data items
.PARAMETER Meta
No description available.
.OUTPUTS

PaginatedClientSeedData<PSCustomObject>
#>

function Initialize-PaginatedClientSeedData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedClientSeedData' | Write-Debug
...
Convert from JSON to PaginatedClientSeedData<PSCustomObject>
...
PaginatedClientSeedData<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientSeedData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedClientSeedData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientSeedData
