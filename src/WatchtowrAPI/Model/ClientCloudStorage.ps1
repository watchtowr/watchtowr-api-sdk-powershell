...
function Initialize-ClientCloudStorage {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientCloudStorage' | Write-Debug
...
function ConvertFrom-JsonToClientCloudStorage {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientCloudStorage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientCloudStorage
        $AllProperties = ("discovery_reason", "type", "source", "status", "created_at", "id", "name", "platform", "url", "businessUnits", "metadata", "customProperties", "criticality")
