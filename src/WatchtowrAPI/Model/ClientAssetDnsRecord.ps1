...
ClientAssetDnsRecord<PSCustomObject>
#>

function Initialize-ClientAssetDnsRecord {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientAssetDnsRecord' | Write-Debug
...
Convert from JSON to ClientAssetDnsRecord<PSCustomObject>
...
ClientAssetDnsRecord<PSCustomObject>
#>
function ConvertFrom-JsonToClientAssetDnsRecord {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientAssetDnsRecord' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientAssetDnsRecord
