...
function ConvertFrom-JsonToPointsOfInterest {
    ...
    Process {
        ...
        $AllProperties = ("id", "name", "type", "url", "discoveryDate", "assetId", "assetName", "assetType", "businessUnits", "lastSeen", "isConcerning", "suppressed", "suppressedAt", "isPermanentSuppression", "findingId")
