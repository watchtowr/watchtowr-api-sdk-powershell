...
function Initialize-KillSwitchDisabledError {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => KillSwitchDisabledError' | Write-Debug
...
function ConvertFrom-JsonToKillSwitchDisabledError {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => KillSwitchDisabledError' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
