...
function Initialize-PaginatedClientSaasPlatform {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedClientSaasPlatform' | Write-Debug
...
function ConvertFrom-JsonToPaginatedClientSaasPlatform {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedClientSaasPlatform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
