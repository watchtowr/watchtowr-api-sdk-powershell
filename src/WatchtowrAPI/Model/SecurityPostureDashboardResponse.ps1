...
function Initialize-SecurityPostureDashboardResponse {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => SecurityPostureDashboardResponse' | Write-Debug
...
function ConvertFrom-JsonToSecurityPostureDashboardResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => SecurityPostureDashboardResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
