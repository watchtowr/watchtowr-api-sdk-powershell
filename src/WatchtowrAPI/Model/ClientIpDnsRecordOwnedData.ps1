...
function Initialize-ClientIpDnsRecordOwnedData {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientIpDnsRecordOwnedData' | Write-Debug
...
function ConvertFrom-JsonToClientIpDnsRecordOwnedData {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientIpDnsRecordOwnedData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
