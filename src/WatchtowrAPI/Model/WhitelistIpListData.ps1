...
WhitelistIpListData<PSCustomObject>
#>

function Initialize-WhitelistIpListData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => WhitelistIpListData' | Write-Debug
...
Convert from JSON to WhitelistIpListData<PSCustomObject>
...
WhitelistIpListData<PSCustomObject>
#>
function ConvertFrom-JsonToWhitelistIpListData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => WhitelistIpListData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WhitelistIpListData
        $AllProperties = ("data")
