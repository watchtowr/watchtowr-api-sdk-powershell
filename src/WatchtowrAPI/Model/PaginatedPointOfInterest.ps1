...
function Initialize-PaginatedPointOfInterest {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedPointOfInterest' | Write-Debug
...
function ConvertFrom-JsonToPaginatedPointOfInterest {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedPointOfInterest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
