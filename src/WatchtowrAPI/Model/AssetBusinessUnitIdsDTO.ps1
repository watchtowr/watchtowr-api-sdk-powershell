...
function Initialize-AssetBusinessUnitIdsDTO {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => AssetBusinessUnitIdsDTO' | Write-Debug
...
function ConvertFrom-JsonToAssetBusinessUnitIdsDTO {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => AssetBusinessUnitIdsDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
