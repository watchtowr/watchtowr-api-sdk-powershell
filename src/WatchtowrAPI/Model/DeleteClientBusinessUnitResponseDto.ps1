...
DeleteClientBusinessUnitResponseDto<PSCustomObject>
#>

function Initialize-DeleteClientBusinessUnitResponseDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => DeleteClientBusinessUnitResponseDto' | Write-Debug
...
Convert from JSON to DeleteClientBusinessUnitResponseDto<PSCustomObject>
...
DeleteClientBusinessUnitResponseDto<PSCustomObject>
#>
function ConvertFrom-JsonToDeleteClientBusinessUnitResponseDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => DeleteClientBusinessUnitResponseDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeleteClientBusinessUnitResponseDto
