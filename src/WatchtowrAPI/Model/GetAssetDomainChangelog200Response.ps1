...
GetAssetDomainChangelog200Response<PSCustomObject>
#>

function Initialize-GetAssetDomainChangelog200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => GetAssetDomainChangelog200Response' | Write-Debug
...
Convert from JSON to GetAssetDomainChangelog200Response<PSCustomObject>
...
GetAssetDomainChangelog200Response<PSCustomObject>
#>
function ConvertFrom-JsonToGetAssetDomainChangelog200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => GetAssetDomainChangelog200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetAssetDomainChangelog200Response
