...
GetAssetSubdomainChangelog200Response<PSCustomObject>
#>

function Initialize-GetAssetSubdomainChangelog200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => GetAssetSubdomainChangelog200Response' | Write-Debug
...
Convert from JSON to GetAssetSubdomainChangelog200Response<PSCustomObject>
...
GetAssetSubdomainChangelog200Response<PSCustomObject>
#>
function ConvertFrom-JsonToGetAssetSubdomainChangelog200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => GetAssetSubdomainChangelog200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetAssetSubdomainChangelog200Response
