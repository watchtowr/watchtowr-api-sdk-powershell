...
UserDetailData<PSCustomObject>
#>

function Initialize-UserDetailData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => UserDetailData' | Write-Debug
...
Convert from JSON to UserDetailData<PSCustomObject>
...
UserDetailData<PSCustomObject>
#>
function ConvertFrom-JsonToUserDetailData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => UserDetailData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UserDetailData
        $AllProperties = ("data")
