...
ClientAdversaryIntelData<PSCustomObject>
#>

function Initialize-ClientAdversaryIntelData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientAdversaryIntelData' | Write-Debug
...
Convert from JSON to ClientAdversaryIntelData<PSCustomObject>
...
ClientAdversaryIntelData<PSCustomObject>
#>
function ConvertFrom-JsonToClientAdversaryIntelData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientAdversaryIntelData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientAdversaryIntelData
        $AllProperties = ("data")
