...
DeleteUserResponseData<PSCustomObject>
#>

function Initialize-DeleteUserResponseData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => DeleteUserResponseData' | Write-Debug
...
Convert from JSON to DeleteUserResponseData<PSCustomObject>
...
DeleteUserResponseData<PSCustomObject>
#>
function ConvertFrom-JsonToDeleteUserResponseData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => DeleteUserResponseData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeleteUserResponseData
        $AllProperties = ("data")
