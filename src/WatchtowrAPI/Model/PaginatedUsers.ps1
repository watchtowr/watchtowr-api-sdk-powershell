...
PaginatedUsers<PSCustomObject>
#>

function Initialize-PaginatedUsers {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedUsers' | Write-Debug
...
Convert from JSON to PaginatedUsers<PSCustomObject>
...
PaginatedUsers<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedUsers {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedUsers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedUsers
