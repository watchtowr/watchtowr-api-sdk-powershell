...
function Initialize-AttackSurfaceResiliencyDto {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => AttackSurfaceResiliencyDto' | Write-Debug
...
function ConvertFrom-JsonToAttackSurfaceResiliencyDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => AttackSurfaceResiliencyDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
