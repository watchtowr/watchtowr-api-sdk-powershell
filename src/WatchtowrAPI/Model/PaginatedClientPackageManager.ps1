...
function Initialize-PaginatedClientPackageManager {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedClientPackageManager' | Write-Debug
...
function ConvertFrom-JsonToPaginatedClientPackageManager {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedClientPackageManager' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
