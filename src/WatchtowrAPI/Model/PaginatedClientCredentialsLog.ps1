...
.PARAMETER VarData
List of credential attempt logs
.PARAMETER Meta
No description available.
.OUTPUTS

PaginatedClientCredentialsLog<PSCustomObject>
#>

function Initialize-PaginatedClientCredentialsLog {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedClientCredentialsLog' | Write-Debug
...
Convert from JSON to PaginatedClientCredentialsLog<PSCustomObject>
...
PaginatedClientCredentialsLog<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientCredentialsLog {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedClientCredentialsLog' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientCredentialsLog
