...
CapabilitySearchResponse<PSCustomObject>
#>

function Initialize-CapabilitySearchResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => CapabilitySearchResponse' | Write-Debug
...
Convert from JSON to CapabilitySearchResponse<PSCustomObject>
...
CapabilitySearchResponse<PSCustomObject>
#>
function ConvertFrom-JsonToCapabilitySearchResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => CapabilitySearchResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CapabilitySearchResponse
