...
GetAssetApiDocumentationChangelog200Response<PSCustomObject>
#>

function Initialize-GetAssetApiDocumentationChangelog200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => GetAssetApiDocumentationChangelog200Response' | Write-Debug
...
Convert from JSON to GetAssetApiDocumentationChangelog200Response<PSCustomObject>
...
GetAssetApiDocumentationChangelog200Response<PSCustomObject>
#>
function ConvertFrom-JsonToGetAssetApiDocumentationChangelog200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => GetAssetApiDocumentationChangelog200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetAssetApiDocumentationChangelog200Response
