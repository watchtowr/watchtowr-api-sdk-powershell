...
.PARAMETER VarData
List of compromised endpoints
.PARAMETER Meta
No description available.
.OUTPUTS

PaginatedClientCompromisedEndpoint<PSCustomObject>
#>

function Initialize-PaginatedClientCompromisedEndpoint {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedClientCompromisedEndpoint' | Write-Debug
...
Convert from JSON to PaginatedClientCompromisedEndpoint<PSCustomObject>
...
PaginatedClientCompromisedEndpoint<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientCompromisedEndpoint {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedClientCompromisedEndpoint' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientCompromisedEndpoint
