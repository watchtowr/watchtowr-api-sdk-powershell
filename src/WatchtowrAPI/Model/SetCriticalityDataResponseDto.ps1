...
SetCriticalityDataResponseDto<PSCustomObject>
#>

function Initialize-SetCriticalityDataResponseDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => SetCriticalityDataResponseDto' | Write-Debug
...
Convert from JSON to SetCriticalityDataResponseDto<PSCustomObject>
...
SetCriticalityDataResponseDto<PSCustomObject>
#>
function ConvertFrom-JsonToSetCriticalityDataResponseDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => SetCriticalityDataResponseDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SetCriticalityDataResponseDto
        $AllProperties = ("data")
