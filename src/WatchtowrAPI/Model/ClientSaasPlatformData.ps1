...
function Initialize-ClientSaasPlatformData {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientSaasPlatformData' | Write-Debug
...
function ConvertFrom-JsonToClientSaasPlatformData {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientSaasPlatformData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
