...
function Initialize-PaginatedClientFindings {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedClientFindings' | Write-Debug
...
function ConvertFrom-JsonToPaginatedClientFindings {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedClientFindings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
