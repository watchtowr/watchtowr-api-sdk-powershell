...
GetAssetContainerChangelog200Response<PSCustomObject>
#>

function Initialize-GetAssetContainerChangelog200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => GetAssetContainerChangelog200Response' | Write-Debug
...
Convert from JSON to GetAssetContainerChangelog200Response<PSCustomObject>
...
GetAssetContainerChangelog200Response<PSCustomObject>
#>
function ConvertFrom-JsonToGetAssetContainerChangelog200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => GetAssetContainerChangelog200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetAssetContainerChangelog200Response
