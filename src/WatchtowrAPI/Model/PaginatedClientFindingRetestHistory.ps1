...
.PARAMETER VarData
List of finding retest history items
.PARAMETER Meta
No description available.
.OUTPUTS

PaginatedClientFindingRetestHistory<PSCustomObject>
#>

function Initialize-PaginatedClientFindingRetestHistory {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedClientFindingRetestHistory' | Write-Debug
...
Convert from JSON to PaginatedClientFindingRetestHistory<PSCustomObject>
...
PaginatedClientFindingRetestHistory<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientFindingRetestHistory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedClientFindingRetestHistory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientFindingRetestHistory
