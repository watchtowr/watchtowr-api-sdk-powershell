...
BadRequestResponse<PSCustomObject>
#>

function Initialize-BadRequestResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => BadRequestResponse' | Write-Debug
...
Convert from JSON to BadRequestResponse<PSCustomObject>
...
BadRequestResponse<PSCustomObject>
#>
function ConvertFrom-JsonToBadRequestResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => BadRequestResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BadRequestResponse
