...
Technology name
.PARAMETER Count
Number of services using this technology
.OUTPUTS

TechnologyStatistic<PSCustomObject>
#>

function Initialize-TechnologyStatistic {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => TechnologyStatistic' | Write-Debug
...
Convert from JSON to TechnologyStatistic<PSCustomObject>
...
TechnologyStatistic<PSCustomObject>
#>
function ConvertFrom-JsonToTechnologyStatistic {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => TechnologyStatistic' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TechnologyStatistic
