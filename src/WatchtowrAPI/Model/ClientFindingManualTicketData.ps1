...
ClientFindingManualTicketData<PSCustomObject>
#>

function Initialize-ClientFindingManualTicketData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientFindingManualTicketData' | Write-Debug
...
Convert from JSON to ClientFindingManualTicketData<PSCustomObject>
...
ClientFindingManualTicketData<PSCustomObject>
#>
function ConvertFrom-JsonToClientFindingManualTicketData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientFindingManualTicketData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientFindingManualTicketData
        $AllProperties = ("data")
