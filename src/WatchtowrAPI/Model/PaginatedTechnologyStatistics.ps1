...
PaginatedTechnologyStatistics<PSCustomObject>
#>

function Initialize-PaginatedTechnologyStatistics {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedTechnologyStatistics' | Write-Debug
...
Convert from JSON to PaginatedTechnologyStatistics<PSCustomObject>
...
PaginatedTechnologyStatistics<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedTechnologyStatistics {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedTechnologyStatistics' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedTechnologyStatistics
