...
function Initialize-PaginatedServiceListing {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedServiceListing' | Write-Debug
...
function ConvertFrom-JsonToPaginatedServiceListing {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedServiceListing' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
