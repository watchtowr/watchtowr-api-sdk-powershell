...
function Initialize-PaginatedClientRepository {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedClientRepository' | Write-Debug
...
function ConvertFrom-JsonToPaginatedClientRepository {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedClientRepository' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
