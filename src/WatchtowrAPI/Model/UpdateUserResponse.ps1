...
UpdateUserResponse<PSCustomObject>
#>

function Initialize-UpdateUserResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => UpdateUserResponse' | Write-Debug
...
Convert from JSON to UpdateUserResponse<PSCustomObject>
...
UpdateUserResponse<PSCustomObject>
#>
function ConvertFrom-JsonToUpdateUserResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => UpdateUserResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UpdateUserResponse
        $AllProperties = ("data")
