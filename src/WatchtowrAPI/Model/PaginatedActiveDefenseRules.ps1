...
PaginatedActiveDefenseRules<PSCustomObject>
#>

function Initialize-PaginatedActiveDefenseRules {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedActiveDefenseRules' | Write-Debug
...
Convert from JSON to PaginatedActiveDefenseRules<PSCustomObject>
...
PaginatedActiveDefenseRules<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedActiveDefenseRules {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedActiveDefenseRules' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedActiveDefenseRules
