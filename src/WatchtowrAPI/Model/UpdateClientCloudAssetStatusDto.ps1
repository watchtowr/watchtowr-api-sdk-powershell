...
function Initialize-UpdateClientCloudAssetStatusDto {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => UpdateClientCloudAssetStatusDto' | Write-Debug
...
function ConvertFrom-JsonToUpdateClientCloudAssetStatusDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => UpdateClientCloudAssetStatusDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
