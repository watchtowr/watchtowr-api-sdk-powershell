...
Status
.PARAMETER CveIds
CVE IDs associated with this hunt
.OUTPUTS

CapabilitySearchHuntItem<PSCustomObject>
#>

function Initialize-CapabilitySearchHuntItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => CapabilitySearchHuntItem' | Write-Debug
        ...
        if ($null -eq $CveIds) {
            throw "invalid value for 'CveIds', 'CveIds' cannot be null."
        }
...
Convert from JSON to CapabilitySearchHuntItem<PSCustomObject>
...
CapabilitySearchHuntItem<PSCustomObject>
#>
function ConvertFrom-JsonToCapabilitySearchHuntItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => CapabilitySearchHuntItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CapabilitySearchHuntItem
        $AllProperties = ("id", "type", "created_at", "updated_at", "total_findings", "total_assets", "hunt_request_type", "rapid_exposure_mechanism", "title", "status", "cve_ids")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "cve_ids"))) {
            throw "Error! JSON cannot be serialized due to the required property 'cve_ids' missing."
        } else {
            $CveIds = $JsonParameters.PSobject.Properties["cve_ids"].value
        }
