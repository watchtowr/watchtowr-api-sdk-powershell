...
ClientSeedDataDto<PSCustomObject>
#>

function Initialize-ClientSeedDataDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => ClientSeedDataDto' | Write-Debug
...
Convert from JSON to ClientSeedDataDto<PSCustomObject>
...
ClientSeedDataDto<PSCustomObject>
#>
function ConvertFrom-JsonToClientSeedDataDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => ClientSeedDataDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientSeedDataDto
