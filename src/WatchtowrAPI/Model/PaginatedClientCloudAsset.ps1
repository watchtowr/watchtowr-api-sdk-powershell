...
function Initialize-PaginatedClientCloudAsset {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedClientCloudAsset' | Write-Debug
...
function ConvertFrom-JsonToPaginatedClientCloudAsset {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedClientCloudAsset' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
