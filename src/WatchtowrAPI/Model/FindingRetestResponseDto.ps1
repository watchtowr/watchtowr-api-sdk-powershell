...
function Initialize-FindingRetestResponseDto {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => FindingRetestResponseDto' | Write-Debug
...
function ConvertFrom-JsonToFindingRetestResponseDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => FindingRetestResponseDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
