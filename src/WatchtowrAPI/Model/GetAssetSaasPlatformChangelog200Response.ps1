...
GetAssetSaasPlatformChangelog200Response<PSCustomObject>
#>

function Initialize-GetAssetSaasPlatformChangelog200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => GetAssetSaasPlatformChangelog200Response' | Write-Debug
...
Convert from JSON to GetAssetSaasPlatformChangelog200Response<PSCustomObject>
...
GetAssetSaasPlatformChangelog200Response<PSCustomObject>
#>
function ConvertFrom-JsonToGetAssetSaasPlatformChangelog200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => GetAssetSaasPlatformChangelog200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetAssetSaasPlatformChangelog200Response
