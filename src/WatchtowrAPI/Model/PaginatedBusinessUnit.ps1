...
function Initialize-PaginatedBusinessUnit {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedBusinessUnit' | Write-Debug
...
function ConvertFrom-JsonToPaginatedBusinessUnit {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedBusinessUnit' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
