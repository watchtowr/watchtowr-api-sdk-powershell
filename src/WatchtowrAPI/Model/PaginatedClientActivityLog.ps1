...
function Initialize-PaginatedClientActivityLog {
    ...
    Process {
        'Creating PSCustomObject: WatchtowrAPI => PaginatedClientActivityLog' | Write-Debug
...
function ConvertFrom-JsonToPaginatedClientActivityLog {
    ...
    Process {
        'Converting JSON to PSCustomObject: WatchtowrAPI => PaginatedClientActivityLog' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
