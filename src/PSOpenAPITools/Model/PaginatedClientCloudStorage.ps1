...
PaginatedClientCloudStorage<PSCustomObject>
#>

function Initialize-PaginatedClientCloudStorage {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedClientCloudStorage' | Write-Debug
...
Convert from JSON to PaginatedClientCloudStorage<PSCustomObject>
...
PaginatedClientCloudStorage<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientCloudStorage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedClientCloudStorage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientCloudStorage
