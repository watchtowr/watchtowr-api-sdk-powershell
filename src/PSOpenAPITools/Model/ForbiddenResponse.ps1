...
function Initialize-ForbiddenResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ForbiddenResponse' | Write-Debug
...
Convert from JSON to ForbiddenResponse<PSCustomObject>
...
ForbiddenResponse<PSCustomObject>
#>
function ConvertFrom-JsonToForbiddenResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ForbiddenResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
