...
ClientIpDnsRecordPointingAtData<PSCustomObject>
#>

function Initialize-ClientIpDnsRecordPointingAtData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientIpDnsRecordPointingAtData' | Write-Debug
...
Convert from JSON to ClientIpDnsRecordPointingAtData<PSCustomObject>
...
ClientIpDnsRecordPointingAtData<PSCustomObject>
#>
function ConvertFrom-JsonToClientIpDnsRecordPointingAtData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientIpDnsRecordPointingAtData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientIpDnsRecordPointingAtData
