...
SecurityPostureDashboardResponse<PSCustomObject>
#>

function Initialize-SecurityPostureDashboardResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SecurityPostureDashboardResponse' | Write-Debug
...
Convert from JSON to SecurityPostureDashboardResponse<PSCustomObject>
...
SecurityPostureDashboardResponse<PSCustomObject>
#>
function ConvertFrom-JsonToSecurityPostureDashboardResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SecurityPostureDashboardResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SecurityPostureDashboardResponse
        $AllProperties = ("data")
