...
function Initialize-OrganizationSummaryDto {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OrganizationSummaryDto' | Write-Debug
...
function ConvertFrom-JsonToOrganizationSummaryDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OrganizationSummaryDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
