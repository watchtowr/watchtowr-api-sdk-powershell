...
function Initialize-UpdateClientFindingStatusRequestBody {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UpdateClientFindingStatusRequestBody' | Write-Debug
...
function ConvertFrom-JsonToUpdateClientFindingStatusRequestBody {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UpdateClientFindingStatusRequestBody' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
