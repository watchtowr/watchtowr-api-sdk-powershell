...
function Initialize-CreateClientNoteDto {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CreateClientNoteDto' | Write-Debug
...
function ConvertFrom-JsonToCreateClientNoteDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CreateClientNoteDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
