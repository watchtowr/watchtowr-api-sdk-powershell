...
PaginatedClientIpRange<PSCustomObject>
#>

function Initialize-PaginatedClientIpRange {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedClientIpRange' | Write-Debug
...
Convert from JSON to PaginatedClientIpRange<PSCustomObject>
...
PaginatedClientIpRange<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientIpRange {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedClientIpRange' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientIpRange
