...
ClientContainerData<PSCustomObject>
#>

function Initialize-ClientContainerData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientContainerData' | Write-Debug
...
Convert from JSON to ClientContainerData<PSCustomObject>
...
ClientContainerData<PSCustomObject>
#>
function ConvertFrom-JsonToClientContainerData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientContainerData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientContainerData
        $AllProperties = ("data")
