...
PaginatedServiceInformationResponse<PSCustomObject>
#>

function Initialize-PaginatedServiceInformationResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedServiceInformationResponse' | Write-Debug
...
Convert from JSON to PaginatedServiceInformationResponse<PSCustomObject>
...
PaginatedServiceInformationResponse<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedServiceInformationResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedServiceInformationResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedServiceInformationResponse
