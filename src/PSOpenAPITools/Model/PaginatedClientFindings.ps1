...
PaginatedClientFindings<PSCustomObject>
#>

function Initialize-PaginatedClientFindings {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedClientFindings' | Write-Debug
...
Convert from JSON to PaginatedClientFindings<PSCustomObject>
...
PaginatedClientFindings<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientFindings {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedClientFindings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientFindings
