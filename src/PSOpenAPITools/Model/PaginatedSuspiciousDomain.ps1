...
PaginatedSuspiciousDomain<PSCustomObject>
#>

function Initialize-PaginatedSuspiciousDomain {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedSuspiciousDomain' | Write-Debug
...
Convert from JSON to PaginatedSuspiciousDomain<PSCustomObject>
...
PaginatedSuspiciousDomain<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedSuspiciousDomain {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedSuspiciousDomain' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedSuspiciousDomain
