...
HuntDetailResponse<PSCustomObject>
#>

function Initialize-HuntDetailResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => HuntDetailResponse' | Write-Debug
...
Convert from JSON to HuntDetailResponse<PSCustomObject>
...
HuntDetailResponse<PSCustomObject>
#>
function ConvertFrom-JsonToHuntDetailResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => HuntDetailResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in HuntDetailResponse
        $AllProperties = ("data")
