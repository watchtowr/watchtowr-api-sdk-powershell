...
function Initialize-ClientBusinessUnitDetail {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientBusinessUnitDetail' | Write-Debug
...
function ConvertFrom-JsonToClientBusinessUnitDetail {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientBusinessUnitDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
