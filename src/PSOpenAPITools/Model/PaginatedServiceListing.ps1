...
PaginatedServiceListing<PSCustomObject>
#>

function Initialize-PaginatedServiceListing {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedServiceListing' | Write-Debug
...
Convert from JSON to PaginatedServiceListing<PSCustomObject>
...
PaginatedServiceListing<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedServiceListing {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedServiceListing' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedServiceListing
