...
PaginatedClientIp<PSCustomObject>
#>

function Initialize-PaginatedClientIp {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedClientIp' | Write-Debug
...
Convert from JSON to PaginatedClientIp<PSCustomObject>
...
PaginatedClientIp<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientIp {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedClientIp' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientIp
