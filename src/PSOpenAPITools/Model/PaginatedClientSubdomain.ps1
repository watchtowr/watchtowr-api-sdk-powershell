...
PaginatedClientSubdomain<PSCustomObject>
#>

function Initialize-PaginatedClientSubdomain {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedClientSubdomain' | Write-Debug
...
Convert from JSON to PaginatedClientSubdomain<PSCustomObject>
...
PaginatedClientSubdomain<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientSubdomain {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedClientSubdomain' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientSubdomain
