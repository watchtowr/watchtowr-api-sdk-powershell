...
ClientDomainData<PSCustomObject>
#>

function Initialize-ClientDomainData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientDomainData' | Write-Debug
...
Convert from JSON to ClientDomainData<PSCustomObject>
...
ClientDomainData<PSCustomObject>
#>
function ConvertFrom-JsonToClientDomainData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientDomainData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientDomainData
        $AllProperties = ("data")
