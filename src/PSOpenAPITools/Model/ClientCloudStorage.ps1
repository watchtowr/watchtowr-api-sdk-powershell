...
ClientCloudStorage<PSCustomObject>
#>

function Initialize-ClientCloudStorage {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientCloudStorage' | Write-Debug
...
Convert from JSON to ClientCloudStorage<PSCustomObject>
...
ClientCloudStorage<PSCustomObject>
#>
function ConvertFrom-JsonToClientCloudStorage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientCloudStorage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientCloudStorage
        $AllProperties = ("type", "source", "status", "created_at", "updated_at", "deleted_at", "id", "name", "platform", "url", "businessUnits", "customProperties", "criticality")
