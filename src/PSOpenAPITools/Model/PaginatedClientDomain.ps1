...
PaginatedClientDomain<PSCustomObject>
#>

function Initialize-PaginatedClientDomain {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedClientDomain' | Write-Debug
...
Convert from JSON to PaginatedClientDomain<PSCustomObject>
...
PaginatedClientDomain<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientDomain {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedClientDomain' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientDomain
