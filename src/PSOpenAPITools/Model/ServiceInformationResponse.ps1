...
function Initialize-ServiceInformationResponse {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServiceInformationResponse' | Write-Debug
...
function ConvertFrom-JsonToServiceInformationResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServiceInformationResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
