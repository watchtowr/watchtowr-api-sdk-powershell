...
AssetsListResponse<PSCustomObject>
#>

function Initialize-AssetsListResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AssetsListResponse' | Write-Debug
...
Convert from JSON to AssetsListResponse<PSCustomObject>
...
AssetsListResponse<PSCustomObject>
#>
function ConvertFrom-JsonToAssetsListResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AssetsListResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AssetsListResponse
