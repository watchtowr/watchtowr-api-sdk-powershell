...
ClientSuspiciousDomainData<PSCustomObject>
#>

function Initialize-ClientSuspiciousDomainData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientSuspiciousDomainData' | Write-Debug
...
Convert from JSON to ClientSuspiciousDomainData<PSCustomObject>
...
ClientSuspiciousDomainData<PSCustomObject>
#>
function ConvertFrom-JsonToClientSuspiciousDomainData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientSuspiciousDomainData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientSuspiciousDomainData
        $AllProperties = ("data")
