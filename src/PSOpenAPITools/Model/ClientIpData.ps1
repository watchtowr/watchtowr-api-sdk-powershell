...
ClientIpData<PSCustomObject>
#>

function Initialize-ClientIpData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientIpData' | Write-Debug
...
Convert from JSON to ClientIpData<PSCustomObject>
...
ClientIpData<PSCustomObject>
#>
function ConvertFrom-JsonToClientIpData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientIpData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientIpData
        $AllProperties = ("data")
