...
PaginatedClientMobileApp<PSCustomObject>
#>

function Initialize-PaginatedClientMobileApp {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedClientMobileApp' | Write-Debug
...
Convert from JSON to PaginatedClientMobileApp<PSCustomObject>
...
PaginatedClientMobileApp<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientMobileApp {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedClientMobileApp' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientMobileApp
