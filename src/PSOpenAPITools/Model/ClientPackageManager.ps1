...
function Initialize-ClientPackageManager {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientPackageManager' | Write-Debug
...
function ConvertFrom-JsonToClientPackageManager {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientPackageManager' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
