...
PaginatedApiDocumentation<PSCustomObject>
#>

function Initialize-PaginatedApiDocumentation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedApiDocumentation' | Write-Debug
...
Convert from JSON to PaginatedApiDocumentation<PSCustomObject>
...
PaginatedApiDocumentation<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedApiDocumentation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedApiDocumentation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedApiDocumentation
