...
KillSwitchForbiddenError<PSCustomObject>
#>

function Initialize-KillSwitchForbiddenError {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => KillSwitchForbiddenError' | Write-Debug
...
Convert from JSON to KillSwitchForbiddenError<PSCustomObject>
...
KillSwitchForbiddenError<PSCustomObject>
#>
function ConvertFrom-JsonToKillSwitchForbiddenError {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => KillSwitchForbiddenError' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in KillSwitchForbiddenError
        $AllProperties = ("message", "error", "statusCode")
