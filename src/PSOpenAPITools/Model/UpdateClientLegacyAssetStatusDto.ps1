...
function Initialize-UpdateClientLegacyAssetStatusDto {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UpdateClientLegacyAssetStatusDto' | Write-Debug
...
function ConvertFrom-JsonToUpdateClientLegacyAssetStatusDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UpdateClientLegacyAssetStatusDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
