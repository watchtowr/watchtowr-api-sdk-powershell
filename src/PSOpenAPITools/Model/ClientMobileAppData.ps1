...
ClientMobileAppData<PSCustomObject>
#>

function Initialize-ClientMobileAppData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientMobileAppData' | Write-Debug
...
Convert from JSON to ClientMobileAppData<PSCustomObject>
...
ClientMobileAppData<PSCustomObject>
#>
function ConvertFrom-JsonToClientMobileAppData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientMobileAppData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientMobileAppData
        $AllProperties = ("data")
