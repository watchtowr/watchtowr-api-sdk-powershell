...
PaginatedClientCloudAsset<PSCustomObject>
#>

function Initialize-PaginatedClientCloudAsset {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedClientCloudAsset' | Write-Debug
...
Convert from JSON to PaginatedClientCloudAsset<PSCustomObject>
...
PaginatedClientCloudAsset<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientCloudAsset {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedClientCloudAsset' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientCloudAsset
