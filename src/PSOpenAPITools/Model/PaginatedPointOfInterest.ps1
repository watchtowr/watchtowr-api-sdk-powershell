...
PaginatedPointOfInterest<PSCustomObject>
#>

function Initialize-PaginatedPointOfInterest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedPointOfInterest' | Write-Debug
...
Convert from JSON to PaginatedPointOfInterest<PSCustomObject>
...
PaginatedPointOfInterest<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedPointOfInterest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedPointOfInterest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedPointOfInterest
