...
function Initialize-PointsOfInterest {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PointsOfInterest' | Write-Debug
...
function ConvertFrom-JsonToPointsOfInterest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PointsOfInterest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PointsOfInterest
        $AllProperties = ("id", "name", "type", "url", "discoveryToolId", "discoveryDate", "assetId", "assetName", "assetType", "businessUnits", "lastSeen")
