...
function Initialize-ClientMobileApp {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientMobileApp' | Write-Debug
...
function ConvertFrom-JsonToClientMobileApp {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientMobileApp' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientMobileApp
        $AllProperties = ("type", "source", "status", "created_at", "updated_at", "deleted_at", "id", "name", "publisher", "platform", "app_id", "url", "s3path", "businessUnits", "customProperties", "criticality")
