...
PaginatedClientPackageManager<PSCustomObject>
#>

function Initialize-PaginatedClientPackageManager {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedClientPackageManager' | Write-Debug
...
Convert from JSON to PaginatedClientPackageManager<PSCustomObject>
...
PaginatedClientPackageManager<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientPackageManager {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedClientPackageManager' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientPackageManager
