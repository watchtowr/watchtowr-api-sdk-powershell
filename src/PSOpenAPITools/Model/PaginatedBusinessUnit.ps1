...
PaginatedBusinessUnit<PSCustomObject>
#>

function Initialize-PaginatedBusinessUnit {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedBusinessUnit' | Write-Debug
...
Convert from JSON to PaginatedBusinessUnit<PSCustomObject>
...
PaginatedBusinessUnit<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedBusinessUnit {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedBusinessUnit' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedBusinessUnit
