...
PaginatedClientPort<PSCustomObject>
#>

function Initialize-PaginatedClientPort {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedClientPort' | Write-Debug
...
Convert from JSON to PaginatedClientPort<PSCustomObject>
...
PaginatedClientPort<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientPort {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedClientPort' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientPort
