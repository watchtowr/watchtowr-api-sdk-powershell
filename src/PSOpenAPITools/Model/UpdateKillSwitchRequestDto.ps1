...
function Initialize-UpdateKillSwitchRequestDto {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UpdateKillSwitchRequestDto' | Write-Debug
...
function ConvertFrom-JsonToUpdateKillSwitchRequestDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UpdateKillSwitchRequestDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
