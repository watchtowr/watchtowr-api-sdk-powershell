...
function Initialize-ClientDomain {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientDomain' | Write-Debug
...
Convert from JSON to ClientDomain<PSCustomObject>
...
ClientDomain<PSCustomObject>
#>
function ConvertFrom-JsonToClientDomain {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientDomain' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
