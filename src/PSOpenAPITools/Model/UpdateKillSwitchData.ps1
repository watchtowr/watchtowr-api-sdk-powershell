...
UpdateKillSwitchData<PSCustomObject>
#>

function Initialize-UpdateKillSwitchData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UpdateKillSwitchData' | Write-Debug
...
Convert from JSON to UpdateKillSwitchData<PSCustomObject>
...
UpdateKillSwitchData<PSCustomObject>
#>
function ConvertFrom-JsonToUpdateKillSwitchData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UpdateKillSwitchData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UpdateKillSwitchData
        $AllProperties = ("data")
