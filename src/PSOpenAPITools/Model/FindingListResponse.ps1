...
FindingListResponse<PSCustomObject>
#>

function Initialize-FindingListResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FindingListResponse' | Write-Debug
...
Convert from JSON to FindingListResponse<PSCustomObject>
...
FindingListResponse<PSCustomObject>
#>
function ConvertFrom-JsonToFindingListResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FindingListResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FindingListResponse
