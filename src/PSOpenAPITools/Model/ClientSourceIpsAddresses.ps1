...
ClientSourceIpsAddresses<PSCustomObject>
#>

function Initialize-ClientSourceIpsAddresses {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientSourceIpsAddresses' | Write-Debug
...
Convert from JSON to ClientSourceIpsAddresses<PSCustomObject>
...
ClientSourceIpsAddresses<PSCustomObject>
#>
function ConvertFrom-JsonToClientSourceIpsAddresses {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientSourceIpsAddresses' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientSourceIpsAddresses
        $AllProperties = ("data")
