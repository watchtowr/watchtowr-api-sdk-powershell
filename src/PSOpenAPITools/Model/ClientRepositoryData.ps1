...
function Initialize-ClientRepositoryData {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientRepositoryData' | Write-Debug
...
function ConvertFrom-JsonToClientRepositoryData {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientRepositoryData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
