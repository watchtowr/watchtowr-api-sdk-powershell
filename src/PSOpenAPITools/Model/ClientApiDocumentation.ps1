...
ClientApiDocumentation<PSCustomObject>
#>

function Initialize-ClientApiDocumentation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientApiDocumentation' | Write-Debug
...
Convert from JSON to ClientApiDocumentation<PSCustomObject>
...
ClientApiDocumentation<PSCustomObject>
#>
function ConvertFrom-JsonToClientApiDocumentation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientApiDocumentation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientApiDocumentation
        $AllProperties = ("data")
