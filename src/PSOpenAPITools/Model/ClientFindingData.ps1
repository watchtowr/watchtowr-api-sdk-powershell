...
ClientFindingData<PSCustomObject>
#>

function Initialize-ClientFindingData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientFindingData' | Write-Debug
...
Convert from JSON to ClientFindingData<PSCustomObject>
...
ClientFindingData<PSCustomObject>
#>
function ConvertFrom-JsonToClientFindingData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientFindingData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientFindingData
        $AllProperties = ("data")
