...
PaginatedClientRepository<PSCustomObject>
#>

function Initialize-PaginatedClientRepository {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedClientRepository' | Write-Debug
...
Convert from JSON to PaginatedClientRepository<PSCustomObject>
...
PaginatedClientRepository<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientRepository {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedClientRepository' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientRepository
