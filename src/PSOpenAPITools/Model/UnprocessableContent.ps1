...
function Initialize-UnprocessableContent {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UnprocessableContent' | Write-Debug
...
function ConvertFrom-JsonToUnprocessableContent {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UnprocessableContent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
