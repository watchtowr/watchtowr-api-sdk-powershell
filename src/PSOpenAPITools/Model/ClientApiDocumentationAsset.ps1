...
function Initialize-ClientApiDocumentationAsset {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientApiDocumentationAsset' | Write-Debug
...
function ConvertFrom-JsonToClientApiDocumentationAsset {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientApiDocumentationAsset' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
