...
ClientSaasPlatformData<PSCustomObject>
#>

function Initialize-ClientSaasPlatformData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientSaasPlatformData' | Write-Debug
...
Convert from JSON to ClientSaasPlatformData<PSCustomObject>
...
ClientSaasPlatformData<PSCustomObject>
#>
function ConvertFrom-JsonToClientSaasPlatformData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientSaasPlatformData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientSaasPlatformData
        $AllProperties = ("data")
