...
ClientDnsRecordListData<PSCustomObject>
#>

function Initialize-ClientDnsRecordListData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientDnsRecordListData' | Write-Debug
...
Convert from JSON to ClientDnsRecordListData<PSCustomObject>
...
ClientDnsRecordListData<PSCustomObject>
#>
function ConvertFrom-JsonToClientDnsRecordListData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientDnsRecordListData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientDnsRecordListData
