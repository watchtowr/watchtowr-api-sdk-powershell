...
PaginatedClientContainer<PSCustomObject>
#>

function Initialize-PaginatedClientContainer {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedClientContainer' | Write-Debug
...
Convert from JSON to PaginatedClientContainer<PSCustomObject>
...
PaginatedClientContainer<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientContainer {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedClientContainer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientContainer
