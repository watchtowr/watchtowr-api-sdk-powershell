...
ClientPackageManagerData<PSCustomObject>
#>

function Initialize-ClientPackageManagerData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientPackageManagerData' | Write-Debug
...
Convert from JSON to ClientPackageManagerData<PSCustomObject>
...
ClientPackageManagerData<PSCustomObject>
#>
function ConvertFrom-JsonToClientPackageManagerData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientPackageManagerData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientPackageManagerData
        $AllProperties = ("data")
