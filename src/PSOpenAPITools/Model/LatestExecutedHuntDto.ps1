...
function Initialize-LatestExecutedHuntDto {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LatestExecutedHuntDto' | Write-Debug
...
function ConvertFrom-JsonToLatestExecutedHuntDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LatestExecutedHuntDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
