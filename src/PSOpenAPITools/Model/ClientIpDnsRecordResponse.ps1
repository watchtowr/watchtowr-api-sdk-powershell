...
ClientIpDnsRecordResponse<PSCustomObject>
#>

function Initialize-ClientIpDnsRecordResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientIpDnsRecordResponse' | Write-Debug
...
Convert from JSON to ClientIpDnsRecordResponse<PSCustomObject>
...
ClientIpDnsRecordResponse<PSCustomObject>
#>
function ConvertFrom-JsonToClientIpDnsRecordResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientIpDnsRecordResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientIpDnsRecordResponse
        $AllProperties = ("data")
