...
function Initialize-ServiceInformationAsset {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServiceInformationAsset' | Write-Debug
...
function ConvertFrom-JsonToServiceInformationAsset {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServiceInformationAsset' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
