...
function Initialize-UpdateClientCustomPropertyDto {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UpdateClientCustomPropertyDto' | Write-Debug
...
function ConvertFrom-JsonToUpdateClientCustomPropertyDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UpdateClientCustomPropertyDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
