...
PaginatedClientSaasPlatform<PSCustomObject>
#>

function Initialize-PaginatedClientSaasPlatform {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedClientSaasPlatform' | Write-Debug
...
Convert from JSON to PaginatedClientSaasPlatform<PSCustomObject>
...
PaginatedClientSaasPlatform<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientSaasPlatform {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedClientSaasPlatform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientSaasPlatform
