...
ClientNoteData<PSCustomObject>
#>

function Initialize-ClientNoteData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientNoteData' | Write-Debug
...
Convert from JSON to ClientNoteData<PSCustomObject>
...
ClientNoteData<PSCustomObject>
#>
function ConvertFrom-JsonToClientNoteData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientNoteData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientNoteData
        $AllProperties = ("data")
