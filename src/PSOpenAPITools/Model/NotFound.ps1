...
function Initialize-NotFound {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NotFound' | Write-Debug
...
Convert from JSON to NotFound<PSCustomObject>
...
NotFound<PSCustomObject>
#>
function ConvertFrom-JsonToNotFound {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NotFound' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NotFound
