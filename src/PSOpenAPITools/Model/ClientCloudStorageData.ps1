...
ClientCloudStorageData<PSCustomObject>
#>

function Initialize-ClientCloudStorageData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientCloudStorageData' | Write-Debug
...
Convert from JSON to ClientCloudStorageData<PSCustomObject>
...
ClientCloudStorageData<PSCustomObject>
#>
function ConvertFrom-JsonToClientCloudStorageData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientCloudStorageData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientCloudStorageData
        $AllProperties = ("data")
