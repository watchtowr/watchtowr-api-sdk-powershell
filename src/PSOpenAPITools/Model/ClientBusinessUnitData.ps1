...
ClientBusinessUnitData<PSCustomObject>
#>

function Initialize-ClientBusinessUnitData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientBusinessUnitData' | Write-Debug
...
Convert from JSON to ClientBusinessUnitData<PSCustomObject>
...
ClientBusinessUnitData<PSCustomObject>
#>
function ConvertFrom-JsonToClientBusinessUnitData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientBusinessUnitData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientBusinessUnitData
        $AllProperties = ("data")
