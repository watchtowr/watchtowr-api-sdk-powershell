...
ClientIpRangeData<PSCustomObject>
#>

function Initialize-ClientIpRangeData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientIpRangeData' | Write-Debug
...
Convert from JSON to ClientIpRangeData<PSCustomObject>
...
ClientIpRangeData<PSCustomObject>
#>
function ConvertFrom-JsonToClientIpRangeData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientIpRangeData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientIpRangeData
        $AllProperties = ("data")
