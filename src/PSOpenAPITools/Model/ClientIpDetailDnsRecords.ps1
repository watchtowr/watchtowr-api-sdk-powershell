...
function Initialize-ClientIpDetailDnsRecords {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientIpDetailDnsRecords' | Write-Debug
...
function ConvertFrom-JsonToClientIpDetailDnsRecords {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientIpDetailDnsRecords' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
