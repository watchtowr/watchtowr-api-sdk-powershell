...
PaginatedHunts<PSCustomObject>
#>

function Initialize-PaginatedHunts {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedHunts' | Write-Debug
...
Convert from JSON to PaginatedHunts<PSCustomObject>
...
PaginatedHunts<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedHunts {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedHunts' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedHunts
