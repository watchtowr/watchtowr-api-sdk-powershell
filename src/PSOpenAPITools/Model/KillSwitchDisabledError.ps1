...
KillSwitchDisabledError<PSCustomObject>
#>

function Initialize-KillSwitchDisabledError {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => KillSwitchDisabledError' | Write-Debug
...
Convert from JSON to KillSwitchDisabledError<PSCustomObject>
...
KillSwitchDisabledError<PSCustomObject>
#>
function ConvertFrom-JsonToKillSwitchDisabledError {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => KillSwitchDisabledError' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in KillSwitchDisabledError
