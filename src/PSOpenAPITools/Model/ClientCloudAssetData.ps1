...
ClientCloudAssetData<PSCustomObject>
#>

function Initialize-ClientCloudAssetData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientCloudAssetData' | Write-Debug
...
Convert from JSON to ClientCloudAssetData<PSCustomObject>
...
ClientCloudAssetData<PSCustomObject>
#>
function ConvertFrom-JsonToClientCloudAssetData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientCloudAssetData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientCloudAssetData
        $AllProperties = ("data")
