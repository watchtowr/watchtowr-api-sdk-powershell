...
PaginatedClientActivityLog<PSCustomObject>
#>

function Initialize-PaginatedClientActivityLog {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedClientActivityLog' | Write-Debug
...
Convert from JSON to PaginatedClientActivityLog<PSCustomObject>
...
PaginatedClientActivityLog<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientActivityLog {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedClientActivityLog' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientActivityLog
