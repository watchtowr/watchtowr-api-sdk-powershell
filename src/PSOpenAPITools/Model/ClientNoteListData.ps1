...
ClientNoteListData<PSCustomObject>
#>

function Initialize-ClientNoteListData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientNoteListData' | Write-Debug
...
Convert from JSON to ClientNoteListData<PSCustomObject>
...
ClientNoteListData<PSCustomObject>
#>
function ConvertFrom-JsonToClientNoteListData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientNoteListData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientNoteListData
