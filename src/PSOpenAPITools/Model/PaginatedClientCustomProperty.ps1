...
PaginatedClientCustomProperty<PSCustomObject>
#>

function Initialize-PaginatedClientCustomProperty {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedClientCustomProperty' | Write-Debug
...
Convert from JSON to PaginatedClientCustomProperty<PSCustomObject>
...
PaginatedClientCustomProperty<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedClientCustomProperty {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedClientCustomProperty' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedClientCustomProperty
