...
ClientSubdomainData<PSCustomObject>
#>

function Initialize-ClientSubdomainData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientSubdomainData' | Write-Debug
...
Convert from JSON to ClientSubdomainData<PSCustomObject>
...
ClientSubdomainData<PSCustomObject>
#>
function ConvertFrom-JsonToClientSubdomainData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientSubdomainData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientSubdomainData
        $AllProperties = ("data")
