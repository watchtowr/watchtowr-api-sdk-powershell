...
function Initialize-SecurityPostureDashboardDto {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SecurityPostureDashboardDto' | Write-Debug
...
function ConvertFrom-JsonToSecurityPostureDashboardDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SecurityPostureDashboardDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
