...
KillSwitchStatusData<PSCustomObject>
#>

function Initialize-KillSwitchStatusData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => KillSwitchStatusData' | Write-Debug
...
Convert from JSON to KillSwitchStatusData<PSCustomObject>
...
KillSwitchStatusData<PSCustomObject>
#>
function ConvertFrom-JsonToKillSwitchStatusData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => KillSwitchStatusData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in KillSwitchStatusData
        $AllProperties = ("data")
