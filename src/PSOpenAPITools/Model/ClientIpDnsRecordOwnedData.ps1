...
ClientIpDnsRecordOwnedData<PSCustomObject>
#>

function Initialize-ClientIpDnsRecordOwnedData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ClientIpDnsRecordOwnedData' | Write-Debug
...
Convert from JSON to ClientIpDnsRecordOwnedData<PSCustomObject>
...
ClientIpDnsRecordOwnedData<PSCustomObject>
#>
function ConvertFrom-JsonToClientIpDnsRecordOwnedData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ClientIpDnsRecordOwnedData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClientIpDnsRecordOwnedData
        $AllProperties = ("data")
