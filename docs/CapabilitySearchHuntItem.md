...
**CveIds** | **String[]** | CVE IDs associated with this hunt | 

## Examples

- Prepare the resource
```powershell
$CapabilitySearchHuntItem = Initialize-WatchtowrAPICapabilitySearchHuntItem  -Id 1 `
 -Type bespoke `
 ...
 -Title ... `
 -Status completed `
 -CveIds [&quot;CVE-2024-3400&quot;,&quot;CVE-2024-5678&quot;]
```

- Convert the resource to JSON
```powershell
$CapabilitySearchHuntItem | ConvertTo-JSON
```
