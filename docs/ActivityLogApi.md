...
$Types = "UserInvite,UserRoleType,UserLock,ResetUser2FA,SetupSSO,DisableSSO,UpdateUserSessionTimeout,SuccessfulLogin,PasswordResetTriggered,UserDelete,UserCreated,UserBusinessUnit,RolePermissionsUpdated,IntegrationSetUp,IntegrationUpdated,IntegrationDeleted,IntegrationTested,KillSwitch,FindingSetting,TestingInfrastructureUpdate,UpdatePriorityPort,PlatformIpWhitelist,AutomaticRetestsUpdated,ReportGenerated,ReportGenerationRequest,ReportDownloaded,AutomaticOutOfScope,PrismaCloudApigeeAccountRemoved,PrismaCloudAccountNameUpdate,ServiceAccountCreated,ServiceAccountUpdated,ServiceAccountDeleted,ServiceAccountEnabled,ServiceAccountDisabled,ServiceAccountTokenRegenerated,PlatformSchedulerGlobalConfigUpdated,PlatformSchedulerDayConfigUpdated,PlatformSchedulerEnabled,PlatformSchedulerDisabled,AssetFavoriteAdded,AssetFavoriteRemoved,ActiveDefenseRuleDeployed,ActiveDefenseRuleApplyExpired,ActiveDefenseRuleApplySucceeded,ActiveDefenseRuleApplyFailed,ActiveDefenseRuleApplyRejected,ActiveDefenseRuleResultIgnored,ActiveDefenseDeploymentModeChanged,ActiveDefenseWafRuleModeChanged,ActiveDefenseAutoDeploymentConnectionAdded,ActiveDefenseAutoDeploymentConnectionRemoved,ActiveDefenseRegistrantContactChanged" # String | Filter logs by a comma separated list of types. (optional)
