...
[**Get-AssetSaasPlatformChangelog**](SaaSPlatformsApi.md#Get-AssetSaasPlatformChangelog) | **GET** /api/client/assets/saasPlatform/show/{id}/changelog | Get SaaS Platform Changelog
...
[**Set-CriticalitySaasPlatform**](SaaSPlatformsApi.md#Set-CriticalitySaasPlatform) | **PUT** /api/client/assets/saasPlatform/show/{id}/criticality | Set Criticality
...
<a id="Get-AssetSaasPlatformChangelog"></a>
# **Get-AssetSaasPlatformChangelog**
> GetAssetSaasPlatformChangelog200Response Get-AssetSaasPlatformChangelog<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Decimal><br>
...
$Id = 8.14 # Decimal | The asset ID of the SaaS Platform to retrieve changelog for.
$Page = 1 # Decimal | The page number for paginated results. If the page field is not provided in the request, it defaults to 1, which corresponds to the first page of results. (optional)
$PageSize = 10 # Decimal | The number of items to be included on each page of paginated results. If the pageSize field is not specified, it defaults to 10. The maximum for pageSize is 30. (optional)

# Get SaaS Platform Changelog
try {
    $Result = Get-AssetSaasPlatformChangelog -Id $Id -Page $Page -PageSize $PageSize
} catch {
    Write-Host ("Exception occurred when calling Get-AssetSaasPlatformChangelog: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **Id** | **Decimal**| The asset ID of the SaaS Platform to retrieve changelog for. | 
 **Page** | **Decimal**| The page number for paginated results. If the page field is not provided in the request, it defaults to 1, which corresponds to the first page of results. | [optional] 
 **PageSize** | **Decimal**| The number of items to be included on each page of paginated results. If the pageSize field is not specified, it defaults to 10. The maximum for pageSize is 30. | [optional] 

### Return type

[**GetAssetSaasPlatformChangelog200Response**](GetAssetSaasPlatformChangelog200Response.md) (PSCustomObject)
...
$IntegrationConnections = "123:aws,456:azure,789:googlecloud" # String | Filter assets by integration connections (comma-separated list of integrationId:integrationType pairs).  Valid integration types: aws, googlecloud, azure, cloudflare, alibabacloud, prismacloud, prismacloudapigee, huaweicloud, tencentcloud, wiz, servicenowcmdb, akamaiedge, fastly, markmonitor, csc, armiscentrix, qualysvmdr, tenablevm, orcasecurity, crowdstrikefalconspotlight, taniumvm, rapid7insightvm, fastlywaf, cloudflarewaf, awswaf, impervawaf, azurewaf, gcpwaf, akamaiwaf, alibabacloudwaf, tencentcloudwaf, huaweicloudwaf, fastlyngwaf, ociwaf  Format: integrationId:integrationType (e.g., 123:aws) Multiple connections: separate with commas (e.g., 123:aws,456:azure,789:googlecloud) (optional)
...
<a id="Set-CriticalitySaasPlatform"></a>
# **Set-CriticalitySaasPlatform**
> SetCriticalityDataResponseDto Set-CriticalitySaasPlatform<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Decimal><br>
...
$Id = 8.14 # Decimal | The asset ID of the SaaS Platform to set criticality for.
$SetCriticalityDto = Initialize-SetCriticalityDto -Criticality "High" # SetCriticalityDto | 

# Set Criticality
try {
    $Result = Set-CriticalitySaasPlatform -Id $Id -SetCriticalityDto $SetCriticalityDto
} catch {
    Write-Host ("Exception occurred when calling Set-CriticalitySaasPlatform: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **Id** | **Decimal**| The asset ID of the SaaS Platform to set criticality for. | 
