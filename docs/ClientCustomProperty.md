...
**ModelType** | **String** | The model type that the custom property is attached to. | 
**ModelId** | **Decimal** | The ID of the model type that the custom property is attached to. | 
...
$ClientCustomProperty = Initialize-WatchtowrAPIClientCustomProperty  -Id 1 `
 ...
 -ModelId 22 `
 -IsPreset false `
 -CreatedAt 2024-09-23T01:24:28.626Z `
 -UpdatedAt 2024-09-23T01:24:28.626Z
```
